...
Logging into your virtual machine (should you need or desire to do so for advanced troubleshooting) is as easy as 
    vagrant ssh 
so long as you have an SSH client in your path
